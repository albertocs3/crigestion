    ...
    <main className="shell">
      ...
      <section className="content stack">
        <div className="panel stack">
          <div><h1>Suscripciones</h1><p className="muted">Contratos periódicos y preparación supervisada de sus renovaciones.</p>{authorization.user.permissions.includes("Subscriptions.RunRenewals") ? <div className="form-actions"><Link className="button button-secondary" href="/app/subscriptions/renewals">Preparar renovaciones</Link><Link className="button button-secondary" href="/app/subscriptions/renewal-exclusions">Pendientes</Link></div> : null}</div>
