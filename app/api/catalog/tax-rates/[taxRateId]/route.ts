...
import {
  ...
  updateCatalogTaxRateStatusSchema
...
export async function PATCH(
  request: Request,
  context: { params: Promise<{ taxRateId: string }> }
) {
  ...
  const payload = updateCatalogTaxRateStatusSchema.safeParse(body);
