...
import { closeCustomerRemittance } from "@/modules/treasury/application/remittances";
...
export async function POST(request: Request, context: RouteContext) {
  ...
  const result = await closeCustomerRemittance(params.remittanceId, authorization.user, {
    correlationId
  });
