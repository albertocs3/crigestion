...
export async function GET(request: Request) {
  ...
  return jsonResponse(request, await listCustomers(payload.data, authorization.user));
}
...
export async function POST(request: Request) {
  ...
  const result = await createCustomer(payload.data, authorization.user, { correlationId });
