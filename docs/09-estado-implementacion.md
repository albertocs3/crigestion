...
| Atencion al cliente | Parcial | Alta, listado, detalle, numeracion anual, responsable, categorias, actuaciones append-only y avance automatico a En curso. Pendientes ciclo de estados completo, colaboradores, comunicaciones, adjuntos, notificaciones e indicadores. |
