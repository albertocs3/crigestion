...
| Atencion al cliente | Parcial | Alta, listado, detalle, numeracion anual, categorias, actuaciones, colaboradores, reasignación y ciclo versionado Nueva/En curso/Pendiente/Resuelta/Cerrada/Reabierta con evidencia PostgreSQL. Pendientes comunicaciones, adjuntos, notificaciones e indicadores. |
