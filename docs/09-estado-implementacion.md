...
| Atencion al cliente | Parcial | Alta, listado, detalle, numeracion anual, responsable, categorias, actuaciones append-only y ciclo versionado Nueva/En curso/Pendiente/Resuelta/Cerrada/Reabierta con evidencia PostgreSQL. Pendientes colaboradores, comunicaciones, adjuntos, notificaciones e indicadores. |
