...
| Atencion al cliente | Parcial | Alta, listado, detalle, numeracion anual, responsable, categorias e historial inicial de incidencias. Pendientes actuaciones, ciclo de estados, colaboradores, comunicaciones, adjuntos, notificaciones e indicadores. |
