...
export function WaiverEvidenceReplacementReview({ detail }: { detail: WaiverEvidenceReplacementDetailDto }) {
  ...
  return <div className="stack">
    ...
    {canDecide ? <div className="stack"><div className="form-actions"><button className="button" type="button" disabled={disabled} onClick={() => void post("approve", { expectedVersion: detail.version })}>{disabled ? "Procesando..." : "Aprobar y contabilizar"}</button></div>
