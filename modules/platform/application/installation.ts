...
const platformPermissions = [
  ...
  ["Support.ChangeIncidentCustomer", "Corregir administrativamente el cliente de una incidencia"],
  ...
  ["Subscriptions.View", "Consultar suscripciones"],
  ...
  ["Subscriptions.WaiveRenewals", "Condonar periodos de renovacion sin facturar"],
  ["Subscriptions.ViewRenewalWaivers", "Consultar el historial de periodos condonados"],
  ...
  ["Accounting.RequestExerciseReopenings", "Solicitar reaperturas de ejercicio"],
  ["Accounting.ApproveExerciseReopenings", "Aprobar reaperturas de ejercicio"]
] as const;
